...
def create
  ...
  if omniauth and params[:service]
    ...
    if service_route == 'facebook'
      ...
      omniauth['info']['email'] ? email =  omniauth['info']['email'] : email = ''    # Twitter API never returns the email address
        ...
        if auth
          ...
          if email != ''
            ...
            if existinguser
              ...
              # flash and sign in
              flash[:myinfo] = 'Your account on Whats My X has been created via ' + provider.capitalize + '. In your profile you can change your personal information and add a local password.'
              sign_in_and_redirect(:user, user)
            end
          else
            flash[:error] =  service_route.capitalize + ' can not be used to sign-up on Whats My X as no valid email address has been provided. Please use another authentication provider or use local sign-up. If you already have an account, please sign-in and add ' + service_route.capitalize + ' from your profile.'
